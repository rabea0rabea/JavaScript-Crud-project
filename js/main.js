...
function anmiscussef(){

$("#messageAdd").animate({"left":"0px"},(2000)) 
$("#messageAdd").animate({"left":"-180px"},(3500)) 
...
function anmiDelet(){
    ...
    $("#messageRemove").animate({"left":"0px"},(2000)) 
    $("#messageRemove").animate({"left":"-180px"},(3000)) 
